package com.merttoptas.kotlin_training.collections.operations

import com.merttoptas.kotlin_training.collections.list.Worker
...
class Operations() {
    ...
    class Store(val receipts: List<Operations.Receipt>, val workers: List<Worker>)
